...
for i in range(1,20):
  ...
  url = "https://www.amazon.in/Apple-iPhone-11-64GB-Product/product-reviews/B07XVKG5XV/ref=cm_cr_dp_d_show_all_btm?ie=UTF8&reviewerType=all_reviews"
  response = requests.get(url)
  soup = bs(response.content,"html.parser")# creating soup object to iterate over the extracted content
  print(soup.prettify())
  reviews = soup.findAll("span", {"data-hook":"review-body"})# Extracting the content under specific tags  
