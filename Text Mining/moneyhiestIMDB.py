# -*- coding: utf-8 -*-
"""
Created on Fri May 29 12:24:27 2020
...
for i in range(1,10):
  ...
  url = "https://www.imdb.com/title/tt6468322/reviews?ref_=tt_sa_3"
  response = requests.get(url)
  soup = bs(response.content,"html.parser")# creating soup object to iterate over the extracted content
  print(soup.prettify())
  reviews = soup.findAll("div", class_="content")# Extracting the content under specific tags  
